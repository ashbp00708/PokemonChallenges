...
namespace Pokemon_Console
{
    class ProgramUI
    {
            ...
            while (continueToRunMenu)
            {
                ...
                switch (userResponse)
                {
                    ...
                    case "4":
                        ...
                        break;
                    case "5":
                        Console.WriteLine("Exiting Team Editor..");
        ...
        private void SeeMyPokemonTeam()
        {
            ...
            {
                Console.WriteLine($"Species Name: {pokemon.SpeciesName}\n" +
                    $"Nick Name: {pokemon.NickName}\n" +
                    $"Level: {pokemon.Level}\n" +
                    $"Primary Type: {pokemon.Primary}\n" +
                    $"Secondary Type: {pokemon.Secondary}\n" +
                    $"Move One: {pokemon.MoveOne}\n" +
                    $"Move Two: {pokemon.MoveTwo}\n" +
                    $"Move Three: {pokemon.MoveThree}\n" +
                    $"Move Four: {pokemon.MoveFour}\n" +
                    $"Team Position: {pokemon.TeamPosition}");
            }
        }  
      }
        ...
        private void UpdateAPokemonTeam()
        {
            List<Pokemon> pokemonTeam = _repo.GetPokemonTeam();
        ...
        private void UpdateAPokemon( teamPosition)
        {
            ...
            private void RemoveAPokemonFromTeam()
            {
                List<Pokemon> pokemonTeam = _repo.GetPokemonTeam();
                if (pokemonTeam.Count == 0)
                {
